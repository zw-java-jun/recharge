...
class OrderApplicationTests {
    ...
    @Test
    public void  t1(){
        Orderinfo orderinfo = orderinfoService.getById(1L);
...
//2、设置数据源
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/orderrr?useUnicode=true&useSSL=false&characterEncoding=utf8&serverTimezone=Asia/Shanghai");
...
//3、包的配置
        ...
        pc.setModuleName("orderinfo"); // 设置模块名
        pc.setParent("com.orderinfo"); // 这个模块在那个位置生成
...
//4、策略配置 （自动注入的字段，乐观锁）
        ...
        strategy.setInclude("orderinfo"); // 设置要映射的表名
